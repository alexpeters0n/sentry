...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AlertRule'
        db.create_table('sentry_alertrule', (
            ('id', self.gf('sentry.db.models.fields.bounded.BoundedBigAutoField')(primary_key=True)),
            ('project_id', self.gf('sentry.db.models.fields.bounded.BoundedPositiveIntegerField')()),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('subscription_id', self.gf('django.db.models.fields.UUIDField')(max_length=32)),
            ...
            ('resolve_threshold', self.gf('django.db.models.fields.IntegerField')()),
            ('threshold_period', self.gf('django.db.models.fields.IntegerField')()),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('sentry', ['AlertRule'])

        # Adding field 'Incident.alert_rule'
        db.add_column('sentry_incident', 'alert_rule',
                      self.gf('django.db.models.fields.related.ForeignKey')(
                          to=orm['sentry.AlertRule'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'AlertRule'
        db.delete_table('sentry_alertrule')

        # Deleting field 'Incident.alert_rule'
        db.delete_column('sentry_incident', u'alert_rule_id')
    ...
    models = {
        ...
        'sentry.alertrule': {
            'Meta': {'unique_together': '()', 'object_name': 'AlertRule', 'index_together': '()'},
            ...
            'subscription_id': ('django.db.models.fields.UUIDField', [], {'max_length': '32'}),
        ...
        'sentry.apiapplication': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': "'e7c087bb4d714ed1acb809e6d6b12155f0b473208035487e9399de3220ce7280'", 'unique': 'True', 'max_length': '64'}),
            'client_secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'2e77eddcbc7546a294001651fc9591befe57fc3ad7fd4fcf9b6b0fd304f1513c'"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'homepage_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Ideal Gnu'", 'max_length': '64', 'blank': 'True'}),
        ...
        'sentry.apigrant': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'a7314bbf52054a7cb712c9aa224c2715'", 'max_length': '64', 'db_index': 'True'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 7, 24, 0, 0)', 'db_index': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.apitoken': {
            ...
            'application': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.ApiApplication']", 'null': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'expires_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 8, 23, 0, 0)', 'null': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
            'refresh_token': ('django.db.models.fields.CharField', [], {'default': "'e3a2f80d3d70481d845e49db21c8d7bda6251f5e80064739895bb419a8f84d01'", 'max_length': '64', 'unique': 'True', 'null': 'True'}),
            'scope_list': ('sentry.db.models.fields.array.ArrayField', [], {'of': (u'django.db.models.fields.TextField', [], {})}),
            'scopes': ('django.db.models.fields.BigIntegerField', [], {'default': 'None'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'2fb3fb59b7bc410bb574e7af35a3bdaf8842513297884ec09e4045fcf27cf201'", 'unique': 'True', 'max_length': '64'}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']"})
        },
        ...
        'sentry.broadcast': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 7, 31, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.groupredirect': {
            'Meta': {'unique_together': "(('previous_short_id', 'previous_project_slug'),)", 'object_name': 'GroupRedirect', 'index_together': '()'},
        ...
        'sentry.groupshare': {
            ...
            'project': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.Project']"}),
            'user': ('sentry.db.models.fields.foreignkey.FlexibleForeignKey', [], {'to': "orm['sentry.User']", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8e2527bc854d4e77a3685078e33daa1c'", 'unique': 'True', 'max_length': '32'})
        },
        'sentry.groupsnooze': {
        ...
        'sentry.scheduleddeletion': {
            ...
            'data': ('sentry.db.models.fields.jsonfield.JSONField', [], {'default': '{}'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_scheduled': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 8, 23, 0, 0)'}),
            'guid': ('django.db.models.fields.CharField', [], {'default': "'d44ffcbe985b4325ae9080816a662ed3'", 'unique': 'True', 'max_length': '32'}),
            'id': ('sentry.db.models.fields.bounded.BoundedBigAutoField', [], {'primary_key': 'True'}),
        ...
        'sentry.sentryapp': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f8f90081-69b3-4706-88bf-b1fbe0bd87d1'", 'max_length': '64'}),
        ...
        'sentry.sentryappinstallation': {
            ...
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'52167d9a-9d6c-416a-9859-d0f33bb7dffa'", 'max_length': '64'})
        },
        'sentry.servicehook': {
            ...
            'project_id': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'db_index': 'True'}),
            'secret': ('sentry.db.models.fields.encrypted.EncryptedTextField', [], {'default': "'a0c8071ea98d4bc4a543e1526629b461a99f8bbebb0348878f581bffd181de44'"}),
            'status': ('sentry.db.models.fields.bounded.BoundedPositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
        ...
        'sentry.useremail': {
            ...
            'validation_hash': ('django.db.models.fields.CharField', [], {'default': "u'jwcpOq4aaLKOtZOLJZs5aK5rhqDE0TWb'", 'max_length': '32'})
        },
        'sentry.userip': {
